...
export const PROJECTS = [
  ...
  },
  {
    ...
    description: (
      <>
        THE LARGEST CANADIAN COMPUTING COMPETITION SOLUTION REPOSITORY WITH 2800+ USERS AND 270+
        CURATED SOLUTIONS
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        AUTOMATED TESTING PLATFORM USING CAT-THEMED AI AGENTS TO SIMULATE USERS AND FIND UX BUGS
        SECURITY ISSUES
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        GENERATE SOLUTION VIDEOS TO MATH PROBLEMS IN THE STYLE 3BLUE1BROWN. WINNER AT IGNITIONHACKS
        V4
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        THIS VERY WEBSITE! AIRBUS A350 FMS-STYLED PERSONAL PORTFOLIO BUILT TO SHOWCASE MY PROJECTS
        AND PASSIONS
      </>
    ),
  ...
  },
  {
    ...
    description: <>SINGLE-PLAYER TOP-DOWN SURVIVAL SHOOTER BUILT USING PYGAME AND PYTMX</>,
    images: [fukushima1],
    date: '2023',
