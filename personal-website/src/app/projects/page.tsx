      ...
      <div className="w-full" style={{ maxWidth: '612px' }}>
        ...
        <div className="relative flex w-full">
          <div className="relative flex w-full">
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    clipPath:
                      activeTab === index
                        ? 'polygon( 11.5% 0%, 88.5% 0%, 100% 110%, 0% 100%)'
                        : 'polygon( 11.5% 0%, 88.5% 0%, 100% 99%, 0% 99%)',
            ...
            {Array.from({ length: Math.max(0, projectsPerPage - currentProjects.length) }).map(
              (_, index) => (
                <div
                  key={`empty-${index}`}
            ...
            {currentProject ? (
              <div className="flex flex-col h-full">
                ...
                <div className="space-y-4 text-white mt-2">
                  {/* Description */}
                  <div className="text-sm leading-relaxed">{currentProject.description}</div>
                  ...
                  <div className="flex space-x-3 -mt-2">
                    ...
                    {!currentProject.link && !currentProject.github && !currentProject.discord && (
                      <div className="text-xs text-gray-500 italic">↳ LINKS COMING SOON</div>
                    )}
                  </div>
                </div>
              </div>
