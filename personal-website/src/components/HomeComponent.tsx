...
// i moved the home page here to allow for blog count to be passed in as a prop
                                    ...
                                    <div className="border p-1.5 inline-block" style={{ borderColor: '#454647' }}>
                                        <div className="flex gap-x-2 items-center">
                                            <div
                                                ...
                                                onMouseEnter={(e) =>
                                                    (e.currentTarget.style.border = '2px solid var(--color-airbus-blue)')
                                                }
                                                onMouseLeave={(e) =>
                        ...
                        UWATERLOO SOFTWARE ENGINEERING
                                ...
                                <div className="flex justify-between items-start mb-8">
                                    ...
                                    <div className="flex flex-col items-center justify-center mt-4 mr-8">
                                        <div className="text-white text-[16px] mb-2">SECOND</div>
                                        <div className="text-airbus-green text-[16px]">CCCSOLUTIONS</div>
                                    </div>
                                </div>
                                ...
                                {/* Stats */}
                                <div>
                                    <div className="text-white text-[17px] mb-4">STATS:</div>

                                    <div className="flex justify-between items-center">
                                        <div className="grid grid-cols-2 gap-x-8 gap-y-3">
                                            <div className="flex justify-between">
                                                <span className="text-white text-[17px]">PROJECTS</span>
                                                <span className="text-airbus-green text-[17px] ml-6">
