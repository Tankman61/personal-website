...
export default function ExternalPower({ powerState, setPowerState }: ExternalPowerProps) {
  ...
  return (
    <div className="flex flex-col items-center p-8 relative">
      ...
      <div
        className="px-8 py-6 rounded-xl relative"
        style={{
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              'inset 2px 2px 4px rgba(0,0,0,0.7), inset -1px -1px 2px rgba(180,180,180,0.4), 0 1px 2px rgba(0,0,0,0.5)',
          }}
        >
                  ...
                  >
                    ...
                    {!isAuto && (
                      <div
                        ...
                        style={{
                          background:
                            'radial-gradient(circle, rgba(142,239,23,0.15) 30%, transparent 70%)',
                          boxShadow:
                            '0 0 8px rgba(142,239,23,0.3), inset 0 0 8px rgba(142,239,23,0.1)',
                        }}
                      />
                    )}
                    <span
                  ...
                  >
                    ...
                    {isAuto && (
                      <div
                        ...
                        style={{
                          background:
                            'radial-gradient(circle, rgba(40,186,253,0.15) 30%, transparent 70%)',
                          boxShadow:
                            '0 0 8px rgba(40,186,253,0.3), inset 0 0 8px rgba(40,186,253,0.1)',
                        }}
                      />
                    )}
